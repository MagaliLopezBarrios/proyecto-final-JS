...
$formu.addEventListener('submit', manejarSubmit)

function manejarSubmit(event){
    event.preventDefault()
    const formu = new FormData(this)
    console.log(formu.get('name'))
    $buttonMailto.setAttribute('href',`maguilopezbarrios@hotmail.com?subject=${form.get('mail')}&body=${form.get('name')} ${form.get('last-name')}`)
    $buttonMailto.click()
